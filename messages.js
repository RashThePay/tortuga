...
const msg = {
  ...
  inspectNotInMistMode: '⚠️ بررسی انبار فقط در مه‌گرفتگی ممکن است.',
...
رای خود را انتخاب کنید:`,
  ...
  treasureCapturedMistMode: (ship) =>
    `💰 یک گنج از کشتی اسپانیایی دزدیده شد و در ${shipLabel(ship)} قرار گرفت! (🌫️ مه‌گرفتگی، انبار مشخص نیست)`,
  ...
  status: (state) => {
    ...
    if (state.mistMode) lines.push('🌫️ *مه‌گرفتگی*');
    lines.push('');
