...
const msg = {
  ...
  dutchDM:
    ...
    '*شرایط برد شما:*\n' +
    '• اگر در پایان بازی ناخدای کشتی‌ای باشید که گنج بیشتری دارد، برنده‌اید.\n' +
    '• اگر حاکم جزیره باشید و بازی مساوی شود، به‌تنهایی برنده‌اید.\n\n' +
    '⚠️ محدودیت: هلندی نمی‌تواند در منازعه جزیره برنده شود.',
  ...
  spanishDM:
    ...
    '⚠️ محدودیت: اسپانیایی نمی‌تواند در منازعه جزیره برنده شود.',
  ...
  captainLeftDuringMutiny: (name, ship) =>
    `⚔️ ناخدای ${shipLabel(ship)} (‏${name}) در زمان شورش کشتی را ترک کرد!\n✅ *شورش موفق شد* و ناخدا برای راند بعد نمی‌تواند به این کشتی برگردد.`,
  ...
  treasureMovedSuccess: (hold) => `✅ گنج به انبار ${TEAM_NAMES[hold]} منتقل شد.`,
